        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$pengunjung_hari_ini?> Orang</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$total_pengunjung?> Orang</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$total_anggota?> Orang</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Pengunjung Perpustakaan</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="areaChart" style="height:280px"></canvas>
              </div>
            </div>
          </div>
          </div>
...
<script type="text/javascript">
  function gettgl() {
      var data = [];
    var url = "<?= base_url('search/grafik') ?>";
    var tgl = [];
    data = $.getJSON(url, function(data) {
      for (var i = 0; i <= data.length; i++) {
        tgl = data[i]['created_at'];
        return tgl;
      }
    })
  }
